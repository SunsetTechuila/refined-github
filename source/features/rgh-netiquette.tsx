...
import {getResolvedText, wasClosedLongAgo, getCloseDate} from './netiquette.js';
	...
	const banner = (
		<Wrapper>
			{createBanner({
				...
				text: <>{getResolvedText(closeDate)} If you want to say something helpful, you can leave a {button}. <strong>Do not</strong> report issues here.</>,
			})}
		</Wrapper>
	);
